...
DAI_LAYER = { # Delitos de Alto Impacto (Por Localidades) - Layer 0
...
IRL_LAYER = { # Incidentes Reportados Localidad - Layer 2
...
CAI_LAYER = { # Comando de Atención Inmediata - Layer 22    
...
# temp QUERY = '/query?where=1=1&outFields=CMIULOCAL,CMNOMLOCAL,CMHP25CONT&f=geojson'